...
import com.example.digitrecognition.CameraManager;
...
*/
    ...
    canvas.drawRect(frame.left - 15, frame.top, frame.left, frame.bottom + 15, paint);
    canvas.drawRect(frame.right - 15, frame.top - 15, frame.right + 15, frame.top, paint);
    canvas.drawRect(frame.right, frame.top - 15, frame.right + 15, frame.bottom + 15, paint);
